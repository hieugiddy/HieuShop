...
<div class="<?php echo $moduleclass_sfx; ?> sp-vmsearch" id="sp-vmsearch-<?php echo $module_id ?>">
    <form action="<?php echo JRoute::_('index.php?option=com_virtuemart&view=category&search=true&limitstart=0' ); ?>" method="get">
        ...
        <div class="search-button-wrapper">
            <button type="submit" class="search-button"><i class="simple-magnifier"></i><span><?php echo JText::_('SP_VMSEARCH_SEARCH_BUTTON') ?></span></button>
        </div>            
        <div class="search-input-wrapper">
            <input type="text" name="keyword" autocomplete="off" class="sp-vmsearch-box" value="<?php echo JRequest:: getVar('keyword') ?>" placeholder="<?php echo JText::_('ENTER_KEYWORDS_HERE');?>"/>
        </div>
    </form>
</div>
