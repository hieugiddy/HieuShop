...
class JFormFieldData extends JFormField
{
    ...
    protected function getInput()
    {
		...
		{
            $j30 = 0;
            $doc->addScript(JURI::root().'modules/mod_vina_css3_image_gallery/assets/js/jquery-1.8.3.min.js', 'text/javascript');
            $doc->addScript(JURI::root().'modules/mod_vina_css3_image_gallery/assets/js/chosen.jquery.min.js', 'text/javascript');
            $doc->addStyleSheet(JURI::root().'modules/mod_vina_css3_image_gallery/assets/css/chosen.css', 'text/css');
        }

        $doc->addScript('https://ajax.googleapis.com/ajax/libs/jqueryui/1.9.1/jquery-ui.min.js', 'text/javascript');
        $doc->addScript(JURI::root().'modules/mod_vina_css3_image_gallery/libs/elements/media/slideset.js', 'text/javascript');
        $doc->addScript(JURI::root().'modules/mod_vina_css3_image_gallery/libs/elements/media/json2.js', 'text/javascript');

        $doc->addStyleSheet('https://ajax.googleapis.com/ajax/libs/jqueryui/1.9.0/themes/cupertino/jquery-ui.css', 'text/css');
        $doc->addStyleSheet(JURI::root().'modules/mod_vina_css3_image_gallery/libs/elements/media/slideset.css', 'text/css');
        ...
        if($this->value){
            ...
            $default->list = array();
            for($i=0;$i<10;$i++){
                $default->list[$i]->name = 'Image Title '.($i+1);
                $default->list[$i]->img = 'modules/mod_vina_css3_image_gallery/samples/image-'.($i+1).'.jpg';
                $default->list[$i]->text = 'This is description for image. Lorem ipsum dolor sit amet, consectetur adipisicing elit.';
        ...
        <div id="tcvnSlideSet-dir">
            <div class="tcvnSlideSet-item">
                <div class="tcvnSlideSet-input">
                    <label>Path</label>
                    <input id="tcvnSlideSet-path" value="<?php if(isset($slide->dir->path)) echo $slide->dir->path; else echo 'modules/mod_vina_css3_image_gallery/samples/'?>"/>
                </div>
